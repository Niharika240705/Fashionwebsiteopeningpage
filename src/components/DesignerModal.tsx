...
export function DesignerModal({ outfit, isOpen, onClose }: DesignerModalProps) {
            ...
            >
              ...
              <div className="p-8 space-y-6">
                ...
                <motion.a
                  ...
                  whileTap={{ scale: 0.98 }}
                  className="w-full bg-black text-white py-4 rounded-full flex items-center justify-center gap-2 hover:bg-black/90 transition-colors"
                >
